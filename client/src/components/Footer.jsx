...
<a href="/" className="footer-logo">
  <img src={DAV1} alt="DAV PG College Logo" className="footer-logo-img" />
  <div className="footer-logo-text">
    <div className="college-name">DAV PG College</div>
    <div className="college-location">Gorakhpur</div>
  </div>
</a>
